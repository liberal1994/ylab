...
public class HttpClientUtil2 {
    ...
    public static void sendPOST(CookieStore cookieStore, Data data) throws IOException {
        ...
        String machineId = MachineEnum.getCodeByName(data.getInstrumentId2());
        ...
        urlParameters.add(new BasicNameValuePair("reserveDate", data.getReserveDate2()));
        urlParameters.add(new BasicNameValuePair("instrumentId", machineId));
        urlParameters.add(new BasicNameValuePair("reserveStartTime", data.getReserveStartTime2()));
        urlParameters.add(new BasicNameValuePair("reserveEndTime", data.getReserveEndTime2()));
        urlParameters.add(new BasicNameValuePair("ReserveReport", data.getReserveReport2()));
